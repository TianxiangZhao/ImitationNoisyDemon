...
# analyze lambda_mi
PU_threshs = [0, 0.2, 0.5, 1]
batched_performance = []
# analyze batch size
for PU_thresh in PU_threshs:
    checkpoint_name = 'pseu{}DEC{}mi{}clust{}ratio{}usebi{}sm{}.pth'.format(lambda_pseudo, use_DEC, lambda_mi, lambda_clus,train_ratio, use_bi, correct_softmax)
    tensorboard_log = 'logs_sepsis/{}_{}_seed{}ratio{}postPUinter{}/lr{}_mi{}_clus{}PU{}thresh{}DEC{}bi{}sm{}pseudo{}_bs{}'.format(env_name, method, seed,
    ...
    '''
    load_path = 'logs_sepsis/pretrained_{}'.format(checkpoint_name)
    best_model = torch.load(load_path)
    trainer.load_models(best_model)
    trainer.trained_bi = use_bi
