...
lambda_temperature = [0.1,1,10,100]
batched_performance = []
# analyze batch size
for temperature in lambda_temperature:
    ...
    tensorboard_log = 'logs_sepsis/{}_{}_seed{}ratio{}postPUinter{}reduced/lr{}_mi{}_clus{}PU{}thresh{}DEC{}bi{}sm{}pseudo{}_hardsel{}temp{}load_best{}__bs{}'.format(env_name, method, seed,
    ...
    (train_batched_demon, exp_batched_demon), scaler= data_sepsis.load_batched_sepsis(load_goal, data_path,batch_size=batch_size,
                                               left_interval=left_interval, right_interval=right_interval, cluster_num=proto_num,
                                                split='all_pos', shuffle=True, pos_ratio=train_ratio, return_scaler=True, reduce=5)
    ...
    if method == 'bi-modeling':
        ...
        trainer = skill_bc.SkillBC(observation_space=np.zeros((43,)), action_space=spaces.Discrete(5),
